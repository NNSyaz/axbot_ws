...
static const _DeviceInfo_type_support_symbol_names_t _DeviceInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, axbot_interfaces, msg, DeviceInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, axbot_interfaces, msg, DeviceInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, axbot_interfaces, msg, DeviceInfo)() {
  return &::axbot_interfaces::msg::rosidl_typesupport_c::DeviceInfo_message_type_support_handle;
}
