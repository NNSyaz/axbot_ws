...
static const _DeviceInfo_type_support_symbol_names_t _DeviceInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, axbot_interfaces, msg, DeviceInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, axbot_interfaces, msg, DeviceInfo)),
  }
};
...
{
  return &::axbot_interfaces::msg::rosidl_typesupport_cpp::DeviceInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, axbot_interfaces, msg, DeviceInfo)() {
  return get_message_type_support_handle<axbot_interfaces::msg::DeviceInfo>();
}
