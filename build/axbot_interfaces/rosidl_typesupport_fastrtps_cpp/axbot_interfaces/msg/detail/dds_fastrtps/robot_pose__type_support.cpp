...
#include "axbot_interfaces/msg/detail/robot_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const axbot_interfaces::msg::RobotPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  axbot_interfaces::msg::RobotPose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = axbot_interfaces::msg::RobotPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const axbot_interfaces::msg::RobotPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<axbot_interfaces::msg::RobotPose *>(
    untyped_ros_message);
...
{
  return &axbot_interfaces::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, axbot_interfaces, msg, RobotPose)() {
  return &axbot_interfaces::msg::typesupport_fastrtps_cpp::_RobotPose__handle;
}
