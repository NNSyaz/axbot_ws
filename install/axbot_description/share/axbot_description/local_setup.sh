...
: ${AMENT_CURRENT_PREFIX:="/media/roboserver/DATA/axbot_ws/install/axbot_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/axbot_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/axbot_description/environment/path.sh"
