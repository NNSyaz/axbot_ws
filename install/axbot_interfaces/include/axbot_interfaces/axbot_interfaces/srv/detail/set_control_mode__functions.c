...
axbot_interfaces__srv__SetControlMode_Request__init(axbot_interfaces__srv__SetControlMode_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->mode)) {
    axbot_interfaces__srv__SetControlMode_Request__fini(msg);
    return false;
  }
  return true;
}
...
axbot_interfaces__srv__SetControlMode_Request__create(void)
{
  ...
  axbot_interfaces__srv__SetControlMode_Request * msg = (axbot_interfaces__srv__SetControlMode_Request *)allocator.allocate(sizeof(axbot_interfaces__srv__SetControlMode_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(axbot_interfaces__srv__SetControlMode_Request));
  bool success = axbot_interfaces__srv__SetControlMode_Request__init(msg);
  if (!success) {
...
axbot_interfaces__srv__SetControlMode_Request__Sequence__init(axbot_interfaces__srv__SetControlMode_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Request * data = NULL;

  if (size) {
    data = (axbot_interfaces__srv__SetControlMode_Request *)allocator.zero_allocate(size, sizeof(axbot_interfaces__srv__SetControlMode_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = axbot_interfaces__srv__SetControlMode_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        axbot_interfaces__srv__SetControlMode_Request__fini(&data[i - 1]);
      }
...
axbot_interfaces__srv__SetControlMode_Request__Sequence__fini(axbot_interfaces__srv__SetControlMode_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      axbot_interfaces__srv__SetControlMode_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Request__Sequence * array = (axbot_interfaces__srv__SetControlMode_Request__Sequence *)allocator.allocate(sizeof(axbot_interfaces__srv__SetControlMode_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = axbot_interfaces__srv__SetControlMode_Request__Sequence__init(array, size);
  if (!success) {
...
axbot_interfaces__srv__SetControlMode_Request__Sequence__destroy(axbot_interfaces__srv__SetControlMode_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    axbot_interfaces__srv__SetControlMode_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
axbot_interfaces__srv__SetControlMode_Request__Sequence__are_equal(const axbot_interfaces__srv__SetControlMode_Request__Sequence * lhs, const axbot_interfaces__srv__SetControlMode_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!axbot_interfaces__srv__SetControlMode_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  axbot_interfaces__srv__SetControlMode_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(axbot_interfaces__srv__SetControlMode_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    axbot_interfaces__srv__SetControlMode_Request * data =
      (axbot_interfaces__srv__SetControlMode_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!axbot_interfaces__srv__SetControlMode_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          axbot_interfaces__srv__SetControlMode_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!axbot_interfaces__srv__SetControlMode_Request__copy(
...
axbot_interfaces__srv__SetControlMode_Response__init(axbot_interfaces__srv__SetControlMode_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    axbot_interfaces__srv__SetControlMode_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Response * msg = (axbot_interfaces__srv__SetControlMode_Response *)allocator.allocate(sizeof(axbot_interfaces__srv__SetControlMode_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(axbot_interfaces__srv__SetControlMode_Response));
  bool success = axbot_interfaces__srv__SetControlMode_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
axbot_interfaces__srv__SetControlMode_Response__Sequence__init(axbot_interfaces__srv__SetControlMode_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Response * data = NULL;

  if (size) {
    data = (axbot_interfaces__srv__SetControlMode_Response *)allocator.zero_allocate(size, sizeof(axbot_interfaces__srv__SetControlMode_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = axbot_interfaces__srv__SetControlMode_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        axbot_interfaces__srv__SetControlMode_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
axbot_interfaces__srv__SetControlMode_Response__Sequence__fini(axbot_interfaces__srv__SetControlMode_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      axbot_interfaces__srv__SetControlMode_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Response__Sequence * array = (axbot_interfaces__srv__SetControlMode_Response__Sequence *)allocator.allocate(sizeof(axbot_interfaces__srv__SetControlMode_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = axbot_interfaces__srv__SetControlMode_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
axbot_interfaces__srv__SetControlMode_Response__Sequence__destroy(axbot_interfaces__srv__SetControlMode_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    axbot_interfaces__srv__SetControlMode_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
axbot_interfaces__srv__SetControlMode_Response__Sequence__are_equal(const axbot_interfaces__srv__SetControlMode_Response__Sequence * lhs, const axbot_interfaces__srv__SetControlMode_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!axbot_interfaces__srv__SetControlMode_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  axbot_interfaces__srv__SetControlMode_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(axbot_interfaces__srv__SetControlMode_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    axbot_interfaces__srv__SetControlMode_Response * data =
      (axbot_interfaces__srv__SetControlMode_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!axbot_interfaces__srv__SetControlMode_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          axbot_interfaces__srv__SetControlMode_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!axbot_interfaces__srv__SetControlMode_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
axbot_interfaces__srv__SetControlMode_Event__init(axbot_interfaces__srv__SetControlMode_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    axbot_interfaces__srv__SetControlMode_Event__fini(msg);
    return false;
  }
  // request
  if (!axbot_interfaces__srv__SetControlMode_Request__Sequence__init(&msg->request, 0)) {
    axbot_interfaces__srv__SetControlMode_Event__fini(msg);
    return false;
  }
  // response
  if (!axbot_interfaces__srv__SetControlMode_Response__Sequence__init(&msg->response, 0)) {
    axbot_interfaces__srv__SetControlMode_Event__fini(msg);
    return false;
  }
  return true;
...
axbot_interfaces__srv__SetControlMode_Event__fini(axbot_interfaces__srv__SetControlMode_Event * msg)
{
  ...
  // request
  axbot_interfaces__srv__SetControlMode_Request__Sequence__fini(&msg->request);
  // response
  axbot_interfaces__srv__SetControlMode_Response__Sequence__fini(&msg->response);
}
...
axbot_interfaces__srv__SetControlMode_Event__are_equal(const axbot_interfaces__srv__SetControlMode_Event * lhs, const axbot_interfaces__srv__SetControlMode_Event * rhs)
{
  ...
  // request
  if (!axbot_interfaces__srv__SetControlMode_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!axbot_interfaces__srv__SetControlMode_Response__Sequence__are_equal(
  ...
  axbot_interfaces__srv__SetControlMode_Event * output)
{
  ...
  // request
  if (!axbot_interfaces__srv__SetControlMode_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!axbot_interfaces__srv__SetControlMode_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Event * msg = (axbot_interfaces__srv__SetControlMode_Event *)allocator.allocate(sizeof(axbot_interfaces__srv__SetControlMode_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(axbot_interfaces__srv__SetControlMode_Event));
  bool success = axbot_interfaces__srv__SetControlMode_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
axbot_interfaces__srv__SetControlMode_Event__Sequence__init(axbot_interfaces__srv__SetControlMode_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Event * data = NULL;

  if (size) {
    data = (axbot_interfaces__srv__SetControlMode_Event *)allocator.zero_allocate(size, sizeof(axbot_interfaces__srv__SetControlMode_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = axbot_interfaces__srv__SetControlMode_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        axbot_interfaces__srv__SetControlMode_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
axbot_interfaces__srv__SetControlMode_Event__Sequence__fini(axbot_interfaces__srv__SetControlMode_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      axbot_interfaces__srv__SetControlMode_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  axbot_interfaces__srv__SetControlMode_Event__Sequence * array = (axbot_interfaces__srv__SetControlMode_Event__Sequence *)allocator.allocate(sizeof(axbot_interfaces__srv__SetControlMode_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = axbot_interfaces__srv__SetControlMode_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
axbot_interfaces__srv__SetControlMode_Event__Sequence__destroy(axbot_interfaces__srv__SetControlMode_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    axbot_interfaces__srv__SetControlMode_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
axbot_interfaces__srv__SetControlMode_Event__Sequence__are_equal(const axbot_interfaces__srv__SetControlMode_Event__Sequence * lhs, const axbot_interfaces__srv__SetControlMode_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!axbot_interfaces__srv__SetControlMode_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  axbot_interfaces__srv__SetControlMode_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(axbot_interfaces__srv__SetControlMode_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    axbot_interfaces__srv__SetControlMode_Event * data =
      (axbot_interfaces__srv__SetControlMode_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!axbot_interfaces__srv__SetControlMode_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          axbot_interfaces__srv__SetControlMode_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!axbot_interfaces__srv__SetControlMode_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
