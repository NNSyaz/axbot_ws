...
static const _RobotPose_type_support_symbol_names_t _RobotPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, axbot_interfaces, msg, RobotPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, axbot_interfaces, msg, RobotPose)),
  }
};
...
{
  return &::axbot_interfaces::msg::rosidl_typesupport_cpp::RobotPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, axbot_interfaces, msg, RobotPose)() {
  return get_message_type_support_handle<axbot_interfaces::msg::RobotPose>();
}
