...
#include "axbot_interfaces/msg/detail/wheel_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = axbot_interfaces::msg::WheelState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const axbot_interfaces::msg::WheelState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<axbot_interfaces::msg::WheelState *>(
    untyped_ros_message);
...
{
  return &axbot_interfaces::msg::typesupport_fastrtps_cpp::_WheelState__handle;
}
