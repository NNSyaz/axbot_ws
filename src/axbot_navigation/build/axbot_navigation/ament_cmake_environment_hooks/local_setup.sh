...
<<<<<<< HEAD
: ${AMENT_CURRENT_PREFIX:="/media/roboserver/DATA/axbot_ws/install/axbot_navigation"}
=======
: ${AMENT_CURRENT_PREFIX:="/media/roboserver/DATA/axbot_ws/src/axbot_navigation/install/axbot_navigation"}
>>>>>>> 84994c6 (Correction)
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/axbot_navigation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/axbot_navigation/environment/path.sh"
