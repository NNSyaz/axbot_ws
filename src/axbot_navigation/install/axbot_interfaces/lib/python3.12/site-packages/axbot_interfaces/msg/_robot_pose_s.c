...
bool axbot_interfaces__msg__robot_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("axbot_interfaces.msg._robot_pose.RobotPose", full_classname_dest, 42) == 0);
  }
  axbot_interfaces__msg__RobotPose * ros_message = _ros_message;
  {  // x
...
PyObject * axbot_interfaces__msg__robot_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("axbot_interfaces.msg._robot_pose");
